  ...
  Offers: [
    {
      ...
      description:
        "261 Statements | TEST | Nationwide Mutual Insurance Company, Advanced Micro Devices, Deree, UGI Corporation, eBay, Whole Foods Market, Susser Holdings Corporation, EOG Resources, Advance Auto Parts, Applied Materials",
      price: 10,
    ...
    },
    {
      ...
      description:
        "276 Statements | TEST | UGI Corporation, Ross Stores, Applied Materials, Murphy Oil, Nationwide Mutual Insurance Company, eBay, Expeditors International, Whole Foods Market, Advanced Micro Devices, Susser Holdings Corporation",
      price: 10,
      status: STATUS_AVAILABLE,
    },
    {
      ...
      description:
        "265 Statements | TEST | Deree, C. H. Robinson Worldwide, ConocoPhillips, Anixter, Advanced Micro Devices Assurant, Starwood Hotels and Resorts Worldwide, Computer Sciences Corporation, Ameriprise Financial, Wells Fargo",
      price: 400,
    ...
    },
    {
      ...
      description:
        "233 Statements | TEST| Overall attitude with customers and colleagues?, How is their work ethic?, Are they likely to pull in others to close sales?, EOG Resources, Johnson Controls, Sherwin-Williams, Con-way, Health Net, Lowe's, Kimberly-Clark",
      price: 400,
      status: STATUS_PURCHASED,
    },
  ],
